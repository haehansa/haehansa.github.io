...
! function () {
    function update() {
        ...
        document.getElementById("timeDate").innerHTML = "This site is running safely&nbsp" + ynum + "&nbspyear&nbsp" + dnum + "&nbspday";
        document.getElementById("times").innerHTML = hnum + "&nbsphour&nbsp" + mnum + "&nbspminute&nbsp" + snum + "&nbspsecond";
    }
    setInterval(update, 1000);
}();
